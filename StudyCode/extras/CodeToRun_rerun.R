...
# The name of the schema that contains the vocabularies (often this will be the same as cdm_database_schema)
...
# Set to FALSE if cohorts already exist in th database
